...
public class ProgramaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            titulo.setText("Programa "+bundle.getString("titulo"));
            tabla_frecSonido = (ArrayList<float[]>) bundle.getSerializable("frec_sonido");
            tabla_frecLED = (ArrayList<float[]>) bundle.getSerializable("frec_led");
            tabla_intensidadLED = (ArrayList<float[]>) bundle.getSerializable("int_led");
            tabla_patrones = (ArrayList<float[]>) bundle.getSerializable("patrones");
        }
